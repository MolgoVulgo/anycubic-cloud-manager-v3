...
`accloud_support_analysis_diagnostics` valide le schéma du bundle complet, une image PNG et un JSON chargé à la demande par couche, les comparaisons de surfaces, les sémantiques choisies, les codes de raison stables et les explications lisibles des décisions.

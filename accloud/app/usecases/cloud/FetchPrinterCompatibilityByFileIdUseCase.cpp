#include "FetchPrinterCompatibilityByFileIdUseCase.h"
...
FetchPrinterCompatibilityByFileIdUseCase::execute(const std::string& fileId) const {
    ...
    return printersApi.compatibilityByFileId(contextResult.context.accessToken,

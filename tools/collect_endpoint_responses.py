...
def _endpoint_sources(section: str) -> list[str]:
    return [
        f"Docs/01_core_web_cloud_sync.md::{section}",
        "Docs/01_core_web_cloud_sync.md",
    ]
...
def collect(args: argparse.Namespace) -> dict[str, Any]:
    ...
    collector.call_workbench(
        name="message_count",
        source_refs=[
            "Docs/01_core_web_cloud_sync.md::2) Endpoints presents dans end_points.md mais non utilises directement par la v2 Python",
            "Docs/01_core_web_cloud_sync.md",
        ],
        method="GET",
...
def render_markdown(report: dict[str, Any]) -> str:
    ...
    lines.append("- Sources endpoints: `Docs/01_core_web_cloud_sync.md`, `Docs/01_core_web_cloud_sync.md`")
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            "Execute les endpoints Anycubic documentes dans Docs/01_core_web_cloud_sync.md + "
            "Docs/01_core_web_cloud_sync.md et produit un rapport."
        )
    )

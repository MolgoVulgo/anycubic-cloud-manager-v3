...
- partial Photon/PWMB parsing and a functional experimental PWSZ 3D development viewer, with fixed stride-two preview and optional two-pass support/model colouring; production integration remains disabled.
